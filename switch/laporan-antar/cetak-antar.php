    ...
    <section class="content text-xs">
        <div class="container-fluid">
            <div class="card-footer justify-content-between no-print">
                <a href="index.php?page=laporan-antar&act=lihat_data&id=<?= $cid; ?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a>
                                        ...
                                        <table class="table table-bordered table-striped table-responsive">
                                            <thead>
                                                <tr class="text-center text-sm">
                                                    ...
                                                    <th>Metode</th>
                                                    <th>Ket</th>
                                                    <th style="width: 13%;">Jumlah Bayar</th>
                                                </tr>
                                            </thead>
                                            <tbody class="text-sm">
                                                <?php
                                                        ...
                                                        if ($detail > 0) {
                                                            while ($item = mysqli_fetch_assoc($it)) {
                                                                ...
                                                                <tr class="text-sm">
                                                                    ...
                                                                    <td class="text-center"><?php echo $row['nm_kelas']; ?></td>
                                                                    <td><?php echo $jenis; ?> ( Maks. <?php echo $jarak; ?> Km)
                                                                    </td>
                                                                    <td class="text-center"><?php echo $row['masa_bulan']; ?>
                                                                    ...
                                                                    <td class="text-center">Rp. <?php echo $row['jml_bayar']; ?></td>
                                                                </tr>
                                                                <?php $no++; ?>
                                                            <?php } ?>
                                                        <?php } ?>
                                                ...
                                                <?php } ?>
                                                <tr>
                                                    <td colspan="9" class="text-right text-sm"><b>Jumlah Total:</b></td>
                                                    <?php 
