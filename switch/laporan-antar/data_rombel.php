    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card-footer justify-content-between">
                <a href="index.php?page=laporan-antar&act=data_kelas&id=<?=$id_kels;?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a>
                <a href="index.php?page=laporan-antar" class="btn btn-warning float-md-right"><i
                ...
                ?>
                        <div class="col-md-4 col-sm-6 col-12">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="index.php?page=laporan-antar&act=lihat_data&id=<?= $value['id_rombel']; ?>" class="small-box-footer">Lihat Data Siswa Per-Kelas <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
