                    ...
                    ?>
                            <div class="info-box mb-4">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Transaksi Pembayaran Baju : <b><?php echo $row['jumlah']; ?>
                                            x</b></span>
                                    <div class="progress">
                                        ...
                                        <ul class="products-list product-list-in-card pl-2 pr-2">
                                            <li class="item">
                                                ...
                                                <div class="product-info">
                                                    <div class="product-title"><?php echo $row['nama_siswa']; ?>
                                                        (<?php echo $row['tingkat']; ?>)
                                                        <span class="badge badge-warning float-right">Rp.
                                                            <?php echo $row['jumlah_byr']; ?></span>
                                                    </div>
                                                    <span class="product-description">
                                                        Kode Bayar : <?php echo $row['kd_bayar_baju']; ?>
                                                    </span>
                                                </div>
                                            </li>
                                        </ul>
                                            ...
                                            <li class="item">
                                                ...
                                                <div class="product-info">
                                                    <div class="product-title"><?php echo $row['nama_siswa']; ?>
                                                        (<?php echo $row['tingkat']; ?>)
                                                        <span class="badge badge-warning float-right">Rp.
                                                            <?php echo $row['jml_bayar']; ?></span>
                                                    </div>
                                                    <span class="product-description">
                                                        Kode Bayar : <?php echo $row['kd_bayar_antar']; ?>
                                                    </span>
                                                </div>
                                            </li>
                                        </ul>
