                        ...
                        <div class="card-footer  no-print">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <!-- <a onclick="JavaScript:window.location.href='index.php?page=bayar-antar&act=export-pdf&id=<?php echo $kd_bayar; ?>';" type="button" class="btn btn-default float-right" style="margin-right: 5px">
                                        <i class="fas fa-print"></i> Print
                                    </a> -->
                                    <!-- <a type="button" href='cetak-antar.php?id=<?php echo $kd_bayar; ?>' target="_blank" class="btn btn-primary float-right" style="margin-right: 5px">
